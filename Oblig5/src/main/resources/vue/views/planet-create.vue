        ...
        <form class="create" @submit="checkForm" :action=`/api/planet-systems/${planetSystemName}/createplanet` method="post">
            ...
            <p>
                <label for="semiMajorAxis">Semi-Major Axis<label>
                    <input type="number" step="0.000001" name="semiMajorAxis" id="semiMajorAxis" v-model="semiMajorAxis" min="0">
            </p>
            <p>
                <label for="eccentricity">Eccentricity<label>
                    <input type="number" step="0.000001" name="eccentricity" id="eccentricity" v-model="eccentricity" min="0">
            </p>
            <p>
                <label for="orbitalPeriod">Orbital Period<label>
                    <input type="number" step="0.000001" name="orbitalPeriod" id="orbitalPeriod" v-model="orbitalPeriod" min="0">
            </p>
            <p>
